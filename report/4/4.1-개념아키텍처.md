...
| AS-09 | 외부 서버 장애 차단 및 계층 복구 (Circuit Breaker) | 외부 연계 | integration.wc · integration.ac · integration.copilot (CB + Fallback) | AD-04 |
| AS-10 | 외부 연계 의존성 캡슐화 (ACL) | 외부 연계 | integration.wc · integration.ac · integration.copilot (ACL 구조, AS-09과 동일 모듈) | AD-09, AD-10 |
