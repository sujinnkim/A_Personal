...
<p align="center"><em>[표 57] 주요 설계 결정 요약</em></p>
...
5. **AS-09**: `integration.meetingManager`(ACL 모듈)를 통해 Meeting Manager를 호출한다. CB가 장애를 감지하면 fallback 처리.
...
2. **AS-03**: `domain.auth`가 L1 Caffeine 조회 → miss 시 L2 Redis 조회.
3. L2도 miss인 경우에만 `integration.copilot`(ACL)을 통해 Copilot Admin 서버 호출 후 L1·L2 동시 적재.
...
<p align="center"><em>[표 58] 설계 전략 적용 매핑</em></p>
...
<p align="center"><em>[표 59] 레이어별 설계 전략 요약</em></p>
...
<p align="center"><em>[표 60] 아키텍처 개념도 표기 범례</em></p>
